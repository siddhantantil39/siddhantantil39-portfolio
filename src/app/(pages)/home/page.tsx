    ...
    return (
      <div className="mx-auto py-8 items-left ">
        <div className="mx-auto  ">
          <h1 className="text-4xl font-bold text-white mb-4 font-montserrat">Overview</h1>
          <div className="">
            {Object.entries(HomeData).map((section, index) => (
              <div key={index} className="py-2">
                <h2 className="text-xl text-white font-semibold mb-2 font-montserrat">{section[0]}</h2>
